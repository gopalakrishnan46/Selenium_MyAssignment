...
public class LegalEntity extends ProjectSpecificMethod {
	...
	public void runLegalEntity(String cname, String dname) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//textarea[@class='slds-textarea'])[2]")).sendKeys(dname);
